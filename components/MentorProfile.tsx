          ...
          <div className="md:col-span-1 flex flex-col items-center text-center p-8 border-b md:border-b-0 md:border-r border-slate-800">
            ...
            <div className="mt-8 w-full bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-slate-700">
              ...
              <button
                ...
                className="mt-6 w-full flex items-center justify-center px-4 py-3 font-bold text-white bg-gradient-to-r from-electric-blue to-neon-purple rounded-lg shadow-lg hover:shadow-xl hover:shadow-electric-blue/40 transition-all duration-300 transform hover:-translate-y-1 active:scale-95"
              >
            ...
            <div className="border-b border-slate-700 px-8">
              <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                <button
                  ...
                  className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-all active:scale-95 ${activeTab === 'about' ? 'border-aqua-green text-aqua-green' : 'border-transparent text-muted-gray hover:text-white hover:border-slate-500'}`}
                >
                  About
                </button>
                <button
                  onClick={() => setActiveTab('chat')}
                  className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-all active:scale-95 ${activeTab === 'chat' ? 'border-aqua-green text-aqua-green' : 'border-transparent text-muted-gray hover:text-white hover:border-slate-500'}`}
                >
                  Live Chat
                </button>
              </nav>
                  ...
                  <div className="pt-2 border-t border-slate-700">
                    <form onSubmit={handleSendMessage} className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className={`flex-shrink-0 p-2.5 rounded-full transition-all active:scale-90 disabled:opacity-50 disabled:cursor-not-allowed ${
                              isRecording
                        ...
                        className="flex-shrink-0 p-2.5 rounded-full bg-electric-blue text-white disabled:bg-slate-600 disabled:cursor-not-allowed transition-all active:scale-90"
